...
/* ----------------------------------------------
 * Generated by Animista on 2020-2-4 20:1:7
...
/* ----------------------------------------------
 * Generated by Animista on 2020-2-4 20:9:31
 * Licensed under FreeBSD License.
 * See http://animista.net/license for more info. 
 * w: http://animista.net, t: @cssanimista
 * ---------------------------------------------- */
...
@keyframes text-focus-in {
  ...
  100% {
	...
	* {
	...
	#ARCREW___Filmmaking___Photogra {
		position: absolute;
		left: 0px;
		top: 0px;
		overflow: visible;
	...
	#HOME:hover{color: rgba(254,204,2,1);}
	#GEAR:hover{color: rgba(254,204,2,1); animation: fade-in 1s cubic-bezier(0.390, 0.575, 0.565, 1.000) both;}
	#PRESETS:hover{color: rgba(254,204,2,1); animation: fade-in 1s cubic-bezier(0.390, 0.575, 0.565, 1.000) both;}
	#PORTFOLIO:hover{color: rgba(254,204,2,1); animation: fade-in 1s cubic-bezier(0.390, 0.575, 0.565, 1.000) both;}
	#HOME {
		position: absolute;
		left: 715px;
		top: 20px;
		...
		--web-action-target: ARCREW Website.html;
		cursor: pointer;
		text-align: left;
		font-family: Montserrat, Arial;
		font-style: normal;
	...
	#Contact_Us__arcrewyt_gmail_com {
		position: absolute;
		left: 0px;
		top: 0.293px;
		overflow: visible;
	...
	.Icon_awesome_instagram:hover{
	background-color: rgb(123, 189, 209);
	transition: 0.5s ease-in;
	}
	.Icon_metro_facebook:hover{
	background-color: rgb(52, 76, 235);
	transition: 0.5s ease-in;
	}
	.Icon_awesome_youtube:hover{
	background-color: rgb(235, 55, 52);
	transition: 0.5s ease-in;
	}
	.Icon_awesome_twitter:hover{
	...
	#_You_can_write_in_every_langua {
		position: absolute;
		left: 435px;
		top: 529px;
		overflow: visible;
...
<body>
<div id="Web_1920___2">
	<img class="fade-in" id="DSC00297" src="DSC00297.jpg">
	<svg class="Rectangle_2">
		<rect fill="rgba(0,0,0,1)" id="Rectangle_2" rx="0" ry="0" x="0" y="0" width="1920" height="1007.288">
		</rect>
	</svg>
	<img class="fade-in" id="ACREW" src="ACREW.png" srcset="ACREW.png 1x, ACREW@2x.png 2x">
	<div id="_Text_ARcrew__">
		<div id="ARCREW___Filmmaking___Photogra">
			<span>ARCREW / Filmmaking & Photography</span><br><span style="font-style:normal;font-weight:normal;color:rgba(255,205,2,1);">Located in </span><span style="font-style:normal;font-weight:normal;text-decoration:true;">Tallinn, Estonia</span>
		</div>
		<svg class="Icon_metro_location" viewBox="8.355 1.928 19.28 30.849">
			<path fill="rgba(255,255,255,1)" id="Icon_metro_location" d="M 17.99496841430664 1.928033471107483 C 12.67082405090332 1.928033471107483 8.354801177978516 6.244056701660156 8.354801177978516 11.56820106506348 C 8.354801177978516 21.2083683013916 17.99496841430664 32.77656936645508 17.99496841430664 32.77656936645508 C 17.99496841430664 32.77656936645508 27.63513565063477 21.2083683013916 27.63513565063477 11.56820106506348 C 27.63513565063477 6.244057178497314 23.31905174255371 1.928033828735352 17.99496841430664 1.928033828735352 Z M 17.99496841430664 17.47280311584473 C 14.73394107818604 17.47280311584473 12.09036636352539 14.82922840118408 12.09036636352539 11.56820106506348 C 12.09036636352539 8.307173728942871 14.73394107818604 5.663598537445068 17.99496841430664 5.663598537445068 C 21.25599670410156 5.663598537445068 23.89957046508789 8.307173728942871 23.89957046508789 11.56820106506348 C 23.89957046508789 14.82922840118408 21.25599479675293 17.47280311584473 17.99496841430664 17.47280311584473 Z M 14.25940322875977 11.56820106506348 C 14.25940322875977 9.505114555358887 15.93188190460205 7.832635879516602 17.99496841430664 7.832635879516602 C 20.05805587768555 7.832635879516602 21.73053359985352 9.505114555358887 21.73053359985352 11.56820106506348 C 21.73053359985352 13.63128757476807 20.05805587768555 15.30376625061035 17.99496841430664 15.30376625061035 C 15.93188095092773 15.30376625061035 14.25940322875977 13.63128757476807 14.25940322875977 11.56820106506348 Z">
			</path>
		</svg>
	</div>
	<div id="Menu">
		<svg class="Rectangle_1">
			<rect fill="rgba(0,0,0,1)" id="Rectangle_1" rx="0" ry="0" x="0" y="0" width="1920" height="60">
			</rect>
		</svg>
		<div id="HOME">
			<span>HOME</span>
	...
	<svg class="Rectangle_1_dy">
		<rect fill="rgba(0,0,0,1)" id="Rectangle_1_dy" rx="0" ry="0" x="0" y="0" width="1920" height="60">
		</rect>
	</svg>
	<div onclick="application.goToTargetView(event)" id="HOME_dz">
		<span>HOME</span>
	</div>
	<div onclick="application.goToTargetView(event)" id="GEAR_d">
		<span>GEAR</span>
	</div>
	<div onclick="application.goToTargetView(event)" id="PRESETS_d">
		<span>PRESETS</span>
	</div>
	<div onclick="application.goToTargetView(event)" id="PORTFOLIO_d">
		<span>PORTFOLIO</span>
	</div>
</div>
</body>
